 ...
 */
class Usu extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Usu the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('Token, Token_Secret', 'length', 'max'=>250),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('idUsuarios, Nombre, Token, Token_Secret, Preferencias_idPreferencias, Eventos_idEventos', 'safe', 'on'=>'search'),
		);
	}
